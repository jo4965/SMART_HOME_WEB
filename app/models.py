...
class Device(db.Model):
    ...
    alarm_type = db.Column(db.INTEGER, nullable=False)
    content = db.Column( db.String(30), nullable=False )
    device_ip = db.Column( db.String(30), nullable=False)
    
    def __init__(self, name, content, alarm_type, device_ip, timestamp):
        self.name = name
